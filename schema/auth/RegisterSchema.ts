...
export const RegisterSchema = z.object({
  ...
  passwordConfirm: z.string({ required_error: 'Pole jest wymagane' }).min(8, { message: 'Hasło powinno mieć przynajmniej 8 znaków' }).trim(),
  birthdayDate: z.string({ required_error: 'Pole Data urodzenia jest wymagane' }).pipe(z.coerce.date({
